  ...
  #define TXT_SET_HOUR "Stunde wählen"
  #define TXT_SET_MIN "Minuten wählen"
  #define TXT_ADV "Werbung:\n"  
  #define TXT_SP_RND "Schnelles Paar zufällig"
  #define TXT_SEL_EXIT2 "\n\nNext: Exit"
  #define TXT_BT_SPAM "BT Spam"
  #define TXT_SA_CRASH "SourApple Crash"
  #define TXT_CMB_BT_SPAM " Kombinierter BT Spam"
  #define TXT_AD_SPAM "Android Spam"
  #define TXT_AJ_TRANSF_NM "Übertragungsnummer"
  #define TXT_AJ_TV_COLOR "TV-Farbbalance"
  #define TXT_STP_NW_PH "Neues Telefon einrichten"
  ...
  #define TXT_INST_PRSS_KEY "   drücke eine Taste"
  ...
  #define TXT_ORANGE "Orange"
  #define TXT_GREENYELLOW "Grün Gelb"
  #define TXT_PINK "Rosa"
  #define TXT_COLOR "Benutzerdef. Farben"
